...
import { adminconfirmpasswordprocess } from '../../../APIs/forgetpasswordAPI'
    ...
    const showTheItems = () => (
      ...
      {ShowUserHeader("fas fa-unlock","co-safe")}
        ...
        <div className="modal-content">
          ...
          <div className="modal-footer">
          <Link to="/login/admin"><button type="submit" className="btn btn-dark text-white">go to login page</button></Link>
          </div>
          }
          </form>
        </div>
